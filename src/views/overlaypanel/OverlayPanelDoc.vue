...
&lt;/OverlayPanel&gt;
					...
					<table class="doc-table">
						...
						<tr>
							...
							<td>event: Browser event <br />
								target: Optional target if event.composedPath()[0] should not be used</td>
			...
			<TabPanel header="Source">
				<a href="https://github.com/primefaces/primevue/tree/2.x/src/views/overlaypanel" class="btn-viewsource" target="_blank" rel="noopener noreferrer">
