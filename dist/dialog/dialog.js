...
this.primevue.dialog = (function (utils, Ripple, vue) {
    ...
    var script = {
        ...
        methods: {
            ...
            initDrag(event) {
                if (utils.DomHandler.hasClass(event.composedPath()[0], 'p-dialog-header-icon') || utils.DomHandler.hasClass(event.composedPath()[0].parentElement, 'p-dialog-header-icon')) {
                    return;
                }
