...
// CONCATENATED MODULE: ./src/components/inputnumber/InputNumber.vue?vue&type=template&id=ce1be2e4&
...
/* harmony default export */ var InputNumbervue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    onInputKeyDown: function onInputKeyDown(event) {
      ...
      var selectionStart = event.composedPath()[0].selectionStart;
      var selectionEnd = event.composedPath()[0].selectionEnd;
      var inputValue = event.composedPath()[0].value;
    ...
    onInputBlur: function onInputBlur(event) {
      this.focused = false;
      var input = event.composedPath()[0];
