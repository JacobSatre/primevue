        ...
        methods: {
            ...
            isOutsideClicked(event) {
                return !(this.$el.isSameNode(event.composedPath()[0]) || this.isNavIconClicked(event) ||
                        this.$el.contains(event.composedPath()[0]) || (this.overlay && this.overlay.contains(event.composedPath()[0])));
            },
            isNavIconClicked(event) {
                return (utils.DomHandler.hasClass(event.composedPath()[0], 'p-datepicker-prev') || utils.DomHandler.hasClass(event.composedPath()[0], 'p-datepicker-prev-icon')
                        || utils.DomHandler.hasClass(event.composedPath()[0], 'p-datepicker-next') || utils.DomHandler.hasClass(event.composedPath()[0], 'p-datepicker-next-icon'));
            },
            alignOverlay() {
                if (this.touchUI) {
                    this.enableModality();
            ...
            onInput(event) {
                ...
                try {
                    ...
                    let value = this.parseValue(event.composedPath()[0].value);
                    if (this.isValidSelection(value)) {
                        this.updateModel(value);
                    }
                }
                catch(err) {
                    this.updateModel(event.composedPath()[0].value);
                }
            },
            onFocus() {
                                  ...
                                  vue.createVNode("div", _hoisted_4, [
                                    ...
                                    ($props.monthNavigator && ($props.view !== 'month') && $props.numberOfMonths === 1)
                                      ? (vue.openBlock(), vue.createBlock("select", {
                                          key: 1,
                                          class: "p-datepicker-month",
                                          onChange: _cache[3] || (_cache[3] = $event => ($options.onMonthDropdownChange($event.composedPath()[0].value)))
                                        }, [
                                    ...
                                    ($props.yearNavigator && $props.numberOfMonths === 1)
                                      ? (vue.openBlock(), vue.createBlock("select", {
                                          key: 3,
                                          class: "p-datepicker-year",
                                          onChange: _cache[4] || (_cache[4] = $event => ($options.onYearDropdownChange($event.composedPath()[0].value)))
                                        }, [
