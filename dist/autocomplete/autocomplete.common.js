...
// CONCATENATED MODULE: ./src/components/autocomplete/AutoComplete.vue?vue&type=template&id=2438ba1c&
...
/* harmony default export */ var AutoCompletevue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    isOutsideClicked: function isOutsideClicked(event) {
      return !this.$refs.overlay.contains(event.composedPath()[0]) && !this.isInputClicked(event) && !this.isDropdownClicked(event);
    },
    isInputClicked: function isInputClicked(event) {
      if (this.multiple) return event.composedPath()[0] === this.$refs.multiContainer || this.$refs.multiContainer.contains(event.composedPath()[0]);else return event.composedPath()[0] === this.$refs.input;
    },
    ...
    onInput: function onInput(event) {
      ...
      var query = event.composedPath()[0].value;
    ...
    onChange: function onChange(event) {
      if (this.forceSelection) {
        var valid = false;
        var inputValue = event.composedPath()[0].value.trim();
