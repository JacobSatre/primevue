...
/* harmony default export */ var TreeNodevue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    onClick: function onClick(event) {
      if (DomHandler_DomHandler.hasClass(event.composedPath()[0], 'p-tree-toggler') || DomHandler_DomHandler.hasClass(event.composedPath()[0].parentElement, 'p-tree-toggler')) {
        return;
      }
    ...
    onKeyDown: function onKeyDown(event) {
      var nodeElement = event.composedPath()[0].parentElement;
...
var component = normalizeComponent(
  ...
  TreeNodevue_type_template_id_0587ce9e_render,
  TreeNodevue_type_template_id_0587ce9e_staticRenderFns,
  false,
  null,
  null,
  null
