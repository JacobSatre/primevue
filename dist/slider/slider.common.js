...
// CONCATENATED MODULE: ./src/components/slider/Slider.vue?vue&type=template&id=2190e750&
...
/* harmony default export */ var Slidervue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    onBarClick: function onBarClick(event) {
      ...
      if (!DomHandler_DomHandler.hasClass(event.composedPath()[0], 'p-slider-handle')) {
        this.updateDomData();
        this.setValue(event);
      }
    },
