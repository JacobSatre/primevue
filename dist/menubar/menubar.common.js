...
var component = normalizeComponent(
  ...
  MenubarSubvue_type_template_id_123a400c_render,
  MenubarSubvue_type_template_id_123a400c_staticRenderFns,
  false,
  null,
  null,
  null
    ...
    bindOutsideClickListener: function bindOutsideClickListener() {
      ...
      if (!this.outsideClickListener) {
        this.outsideClickListener = function (event) {
          if (_this.mobileActive && _this.$refs.rootmenu.$el !== event.composedPath()[0] && !_this.$refs.rootmenu.$el.contains(event.composedPath()[0]) && _this.$refs.menubutton !== event.composedPath()[0] && !_this.$refs.menubutton.contains(event.composedPath()[0])) {
