...
// CONCATENATED MODULE: ./src/components/confirmdialog/ConfirmDialog.vue?vue&type=template&id=06cc6d1e&
...
/* harmony default export */ var Dialogvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    onMaskClick: function onMaskClick(event) {
      if (this.dismissableMask && this.closable && this.modal && this.$refs.mask === event.composedPath()[0]) {
        this.close();
      }
    },
...
var component = normalizeComponent(
  ...
  Dialogvue_type_template_id_494e16b5_render,
  Dialogvue_type_template_id_494e16b5_staticRenderFns,
  false,
  null,
  null,
  null
...
/* harmony default export */ var ConfirmDialogvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    closeDialog: function closeDialog($event) {
      if (DomHandler_DomHandler.hasClass($event.composedPath()[0], 'p-dialog-header-close') || DomHandler_DomHandler.hasClass($event.composedPath()[0], 'p-dialog-header-close-icon')) {
        ConfirmationEventBus.off('confirm');
        ConfirmationEventBus.off('close');
        this.visible = false;
      }
