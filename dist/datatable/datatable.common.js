...
// CONCATENATED MODULE: ./src/components/datatable/DataTable.vue?vue&type=template&id=1301c00c&
...
/* harmony default export */ var BodyCellvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    moveToPreviousCell: function moveToPreviousCell(event) {
      var currentCell = this.findCell(event.composedPath()[0]);
...
var BodyCell_component = normalizeComponent(
  ...
  BodyCellvue_type_template_id_24f80103_render,
  BodyCellvue_type_template_id_24f80103_staticRenderFns,
  false,
  null,
  null,
  null
...
/* harmony default export */ var DataTablevue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    onRowClick: function onRowClick(e) {
      ...
      if (DomHandler_DomHandler.isClickable(event.composedPath()[0])) {
        return;
      }
    ...
    onColumnHeaderMouseDown: function onColumnHeaderMouseDown(e) {
      ...
      if (this.reorderableColumns && column.reorderableColumn) {
        if (event.composedPath()[0].nodeName === 'INPUT' || event.composedPath()[0].nodeName === 'TEXTAREA' || DomHandler_DomHandler.hasClass(event.composedPath()[0], 'p-column-resizer')) event.currentTarget.draggable = false;else event.currentTarget.draggable = true;
      }
    },
    onColumnHeaderDragStart: function onColumnHeaderDragStart(event) {
    ...
    onColumnHeaderDragOver: function onColumnHeaderDragOver(event) {
      var dropHeader = this.findParentHeader(event.composedPath()[0]);
    ...
    onColumnHeaderDrop: function onColumnHeaderDrop(event) {
      ...
      if (this.draggedColumn) {
        ...
        var dropIndex = DomHandler_DomHandler.index(this.findParentHeader(event.composedPath()[0]));
    ...
    onRowMouseDown: function onRowMouseDown(event) {
      if (DomHandler_DomHandler.hasClass(event.composedPath()[0], 'p-datatable-reorderablerow-handle')) event.currentTarget.draggable = true;else event.currentTarget.draggable = false;
    },
