...
this.primevue.datatable = (function (utils, api, Paginator, vue, OverlayEventBus, Dropdown, Button, Ripple) {
    ...
    var script = {
        ...
        methods: {
            ...
            onRowClick(e) {
                const event = e.originalEvent;
                if (utils.DomHandler.isClickable(event.composedPath()[0])) {
                    return;
                }
            ...
            onColumnHeaderMouseDown(e) {
                ...
                if (this.reorderableColumns && this.columnProp(column, 'reorderableColumn') !== false) {
                    if (event.composedPath()[0].nodeName === 'INPUT' || event.composedPath()[0].nodeName === 'TEXTAREA' || utils.DomHandler.hasClass(event.composedPath()[0], 'p-column-resizer'))
            ...
            onColumnHeaderDrop(event) {
                ...
                if (this.draggedColumn) {
                    ...
                    let dropIndex = utils.DomHandler.index(this.findParentHeader(event.composedPath()[0]));
            ...
            onRowMouseDown(event) {
                if (utils.DomHandler.hasClass(event.composedPath()[0], 'p-datatable-reorderablerow-handle'))
                    event.currentTarget.draggable = true;
                else
                    event.currentTarget.draggable = false;
            },
