...
// CONCATENATED MODULE: ./src/components/cascadeselect/CascadeSelect.vue?vue&type=template&id=e5129604&
    ...
    bindOutsideClickListener: function bindOutsideClickListener() {
      ...
      if (!this.outsideClickListener) {
        this.outsideClickListener = function (event) {
          if (_this.overlayVisible && _this.$refs.overlay && !_this.$el.contains(event.composedPath()[0]) && !_this.$refs.overlay.contains(event.composedPath()[0])) {
            _this.hide();
          }
        };
