...
/* harmony default export */ var OrganizationChartNodevue_type_script_lang_js_ = ({
  ...
  methods: {
    onNodeClick: function onNodeClick(event) {
      if (DomHandler_DomHandler.hasClass(event.composedPath()[0], 'p-node-toggler') || DomHandler_DomHandler.hasClass(event.composedPath()[0], 'p-node-toggler-icon')) {
        return;
      }
...
var component = normalizeComponent(
  ...
  OrganizationChartNodevue_type_template_id_34835483_render,
  OrganizationChartNodevue_type_template_id_34835483_staticRenderFns,
  false,
  null,
  null,
  null
