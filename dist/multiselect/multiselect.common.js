...
// CONCATENATED MODULE: ./src/components/multiselect/MultiSelect.vue?vue&type=template&id=363a4882&
...
/* harmony default export */ var MultiSelectvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    onClick: function onClick() {
      if (!this.disabled && (!this.$refs.overlay || !this.$refs.overlay.contains(event.composedPath()[0])) && !DomHandler_DomHandler.hasClass(event.composedPath()[0], 'p-multiselect-close')) {
    ...
    onOptionKeyDown: function onOptionKeyDown(event, option) {
      var listItem = event.composedPath()[0];
