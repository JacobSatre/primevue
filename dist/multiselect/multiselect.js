    ...
    var script = {
        ...
        methods: {
            ...
            onClick(event) {
                ...
                if ((!this.overlay || !this.overlay.contains(event.composedPath()[0])) && !utils.DomHandler.hasClass(event.composedPath()[0], 'p-multiselect-close')) {
                    utils.DomHandler.hasClass(event.composedPath()[0], 'p-multiselect-close');
