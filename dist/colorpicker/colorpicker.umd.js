...
// CONCATENATED MODULE: ./src/components/colorpicker/ColorPicker.vue?vue&type=template&id=0785a3b8&
    ...
    bindOutsideClickListener: function bindOutsideClickListener() {
      ...
      if (!this.outsideClickListener) {
        this.outsideClickListener = function (event) {
          if (_this.overlayVisible && _this.$refs.picker && !_this.$refs.picker.contains(event.composedPath()[0]) && !_this.isInputClicked(event)) {
