    ...
    bindOutsideClickListener: function bindOutsideClickListener() {
      ...
      if (!this.outsideClickListener) {
        this.outsideClickListener = function (event) {
          if (_this.overlayVisible && _this.$refs.container && !_this.$refs.container.contains(event.composedPath()[0]) && !_this.isTargetClicked(event)) {
            _this.hide();
          }
        };
...
var Menu_component = normalizeComponent(
  ...
  Menuvue_type_template_id_1b496c2a_render,
  Menuvue_type_template_id_1b496c2a_staticRenderFns,
  false,
  null,
  null,
  null
